            ...
            <Card.Header className='row'>
                ...
                <div className='col d-flex flex-column justify-content-center'>
                    ...
                    <div className='post-organisation'>
                        <Button variant="none" className='text-primary mb-0 button-text ps-0' onClick={() => navigate(`/organisation/${postObj.user[0].organisation}`)}>{postObj.user[0].organisation}</Button>
                    </div>
                </div>
            </Card.Header>
            <Card.Body>
